...
class CWATModel_dyn(DynamicModel):
    ...
    def dynamic(self):
        ...
        # ***** RAIN AND SNOW *****************************************
        #self.snowfrost_module.dynamic() #Peter Greve test
        #timemeasure("Snow")  # 3. timing #  Peter Greve test
        ...
        self.waterdemand_module.dynamic() # Peter Greve test
        ...
        #self.runoff_concentration_module.dynamic() # Peter Greve test
...
#            #self.var.totalET_WB = self.var.EvapoChannel # Peter Greve test
...
#
#                #self.var.totalET_WB = self.var.totalET_WB + self.var.totalET + self.var.EvapWaterBodyM # Peter Greve test
#                #if returnBool('useSmallLakes'):
