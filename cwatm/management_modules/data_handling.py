...
def metaNetCDF():
    """
    get the map metadata from runoff netcdf maps
    """
    ...
    try:
        ...
        raise CWATMFileError(cbinding('RunoffMaps'),msg) # Peter Greve test
...
def writenetcdf(netfile,prename,addname,varunits,inputmap, timeStamp, posCnt, flag,flagTime, nrdays=None, dateunit="days"):
    ...
    if not flag:
        ...
        nf1.Source_Software = 'C-CWATM Python: ' + versioning['exe']
        ...
        nf1.source = 'C-CWATM output maps'
