    ...
    **Functions**
    ...
    def dynamic(self):
        ...
        * get non-Irrigation water demand and its return flow fraction
        ...
        soilWaterStorage = self.var.rootzoneSM
        ...
        readAvlWater = soilWaterStorage - (self.var.wwp1[No] + self.var.wwp2[No])
        ...
        #wCrit1 = (0.5 * (self.var.wfc1[No] - self.var.wwp1[No])) + self.var.wwp1[No]
        #wCrit2 = (0.5 * (self.var.wfc2[No] - self.var.wwp2[No])) + self.var.wwp2[No]
        ...
        if checkOption('paddy_irrig'): #Peter Greve Test
