...
def usage():
    ...
    * -t --printtime   the computation time for hydrological modules are printed
    ...
    """
    print('C-CWatM - Climate-Community Water Model')
...
def CWATMexe(settings):
    ...
    * runs the model
    ...
    checkifDate('StepStart', 'StepEnd', 'SpinUp', cbinding('RunoffMaps'))
...
def headerinfo():
    ...
    if not (Flags['veryquiet']) and not (Flags['quiet']):
        print("C-CWATM: Climate-Community Water Model ", __version__, " Date: ", versioning['lastdate'], " ")
        print("UWaRes, Helmholtz-Zentrum Hereon")
